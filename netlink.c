...
static char* get_syscall_table(void){
    ...
    md5_hash(result,(char *)sys_call_table,435*sizeof(sys_call_table));
    // printk("test2  %s",result);
    return result;
